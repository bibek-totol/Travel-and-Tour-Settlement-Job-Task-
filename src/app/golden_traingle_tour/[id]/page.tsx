...
import { CheckCircle2, XCircle, Globe, Star } from "lucide-react";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
          ...
          <div className="flex flex-col items-center border p-4 rounded-xl shadow-sm">
            ...
            <div className="flex justify-center space-x-2 p-2">
              {tour.languages.map((lang: string, index: number) => (
                <span
                  key={index}
                  className="text-gray-600 text-[13px] lg:text-[16px]"
                >
                  {lang}
                </span>
              ))}
          ...
          {reviews.map((r) => (
            <div key={r.id} className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <button className="flex items-center text-gray-500 text-sm mt-2 hover:text-gray-700">
